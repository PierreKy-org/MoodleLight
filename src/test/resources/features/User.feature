Feature: Modification for the User
  ...
  Scenario: The user change his userId
    Given a Student with the login "testStudent3"
    When "testStudent3" change his "userId" to "987"
    Then the response is '^\{"id":"987"\}$'
    And "testStudent3" new "id" is "987"
  ...
  Scenario : A User try to change the userName of an other User
    Given a Student with the login "testStudent3"
  ...
  Scenario: A User try to change the userId of an other User
    Given a Student with the login "testStudent3"
    And a Student with the login "testStudent4"
    When "testStudent3" try to change the "userName" of "testStudent4" to "azertyuiop"
    Then the response is '^\{"message":"Error : Permission denied"\}$'

  Scenario: A User try to change the email of an other User
    Given a Student with the login "testStudent3"
    And a Student with the login "testStudent4"
    When "testStudent3" try to change the "userId" of "testStudent4" to "azertyuiop"
    Then the response is '^\{"message":"Error : Permission denied"\}$'

  Scenario: A User try to change the password of an other User
    Given a Student with the login "testStudent3"
    And a Student with the login "testStudent4"
